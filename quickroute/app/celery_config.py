"""
Celery configuration for QuickRoute.
...
celery_app.conf.update(
    ...
    # Task routing
    task_routes={
        'app.celery_tasks.*': {'queue': 'celery'},
        'app.example_celery_tasks.*': {'queue': 'default'},
    },
    ...
    beat_schedule={},
    beat_scheduler='django_celery_beat.schedulers:DatabaseScheduler' if hasattr(settings, 'USE_CELERY_BEAT') and settings.USE_CELERY_BEAT else 'celery.beat:Schedulers',
)
